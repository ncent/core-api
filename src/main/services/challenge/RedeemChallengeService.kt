...
//    fun execute(caller: String, challenge: Challenge, completerPublicKey: String) : SOAResult<TransactionList> {
...
//
//        // validate public key has any shares available -- without any they cannot complete
//        val sharabilityResult = ValidateShareService.execute(completerPublicKey, challenge)
//
...
//            return SOAResult(SOAResultType.FAILURE, "Public key must have a share in order to complete")
//
